...
# 5. How is a class attribute different than an instance attribute? Give an example of when you
# might use each.
...
# Directions: Make Python classes that could store the each of the following three pieces of data.
# Use the dictionaries below as examples to guide you in creating class definitions for the
# following objects. Define an __init__ method to allow callers of this class to provide initial
...
# Questions are a question & a correct answer; here are two example questions. Write a class that
# could store data like this:
...
class Exam(object):
    ...
    def administer(self):
        ...
        return (self.score / len(self.questions)) * 100.0
...
def quiz_example():
    ...
    take_test(quiz, chriki_chekorir)
